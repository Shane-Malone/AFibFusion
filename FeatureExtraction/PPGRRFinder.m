function [RRIntervalSet, sec_locs, final_sig_tab, signal2plot, ppg_wav_win, ppgfin_sig_tab]= PPGRRFinder(ppgInput,Fs)
...
%%%%%%%ADDITIVE FUSION
   ...
   ppgfin_sig=ppg_sig.*4; %%ppg wavelet sequence amplitude is almost 4 times smaller than ecg
...
signal2plot=[ppgsignal]'; %%%%for plotting purpo
