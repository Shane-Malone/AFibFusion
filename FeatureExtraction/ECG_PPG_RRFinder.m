function [RRIntervalSet, sec_locs, final_sig_tab, signal2plot, ecgsqi_orig, ppgsqi_orig, ppg_wav_win, ecg_wav_win, ppgfin_sig_tab, ecgfin_sig_tab]= ECG_PPG_RRFinder(ecgInput,ppgInput,Fs,delay)
